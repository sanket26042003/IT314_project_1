...
class ManagerProfile extends StatelessWidget {
  ...
  const ManagerProfile({super.key, required this.data});
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          if (constraints.maxWidth < 600) {
            return  SingleChildScrollView(child: MobileBody(data:data,));
          } else {
            return  SingleChildScrollView(child: DesktopBody(data: data,));
          }
        },
      ),
    );
            ...
            child: Column(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: NetworkImage("https://th.bing.com/th/id/OIG.Zm7JwGm2K.5G5w2KJ1rr?pid=ImgGn"),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              ProfileDetailRow(
                  title: 'Department', value: data['DepartmentName']),
              ProfileDetailRow(
                  title: 'Current Project',
                  value: data['Project']),
            ],
